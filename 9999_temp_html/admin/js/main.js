  ...
  $(".formlist").sortable({
    ...
    delay: 150,
      ...
      stop: function( event, ui ) {
            ...
            var sort_index = $(".formlist .formlistitem",wraphtml).index(ui.item);   
            var wraphtml = ui.item.parents(".formlist");
            var wraphtml_2 = ui.item.parents(".formgroup");
            var url=urlObj.urlEditFieldSort;

            group_id = $( ".group_id",wraphtml_2).val();
            ...
            postdata['data[Form][sort_index]'] =sort_index;
            postdata['data[Form][no_parameter]'] =postdata_hidden;
