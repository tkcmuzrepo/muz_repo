...
function makenewgroupinitialize(){
  ...
  // グループソート表示/非表示の入れ替え
  $( ".managementformwarap").bind("sortupdate", function(event, ui) { 


        $( ".managementform",$(this)).each(function() {
            ...
            var wraphtml = $(this);
            var wraphtmlShow = $(this).parents(".managementformwarap");
            ...
            postdata['data['+postPass+'][showflag]'] =showflag;
